    ...
    <group position={[0, 0, 0]}>
      ...
      {pods.map((pod, i) => (
        <group key={i} position={[pod.x, 0, pod.z]}>
          ...
          <mesh position={[0, 2.25, -2.1]}>
            ...
            <meshStandardMaterial color="#111111" roughness={0.95} metalness={0} />
          </mesh>
          {/* Left side wall */}
      ...
      <group position={[2, 0, -2]}>
        ...
        <mesh position={[0, 4.52, 0]}>
          ...
          <meshStandardMaterial color="#111111" roughness={0.30} metalness={0.60} />
        </mesh>
      ...
      {[-1, 1].map((x, i) => (
        <group key={i} position={[x * 1.5 + 9, 0, -5.5]}>
          ...
          <mesh position={[0, 2.9, 0]}>
            ...
            <meshStandardMaterial color="#080808" roughness={0.70} metalness={0.30} />
          </mesh>
          {/* Door surface */}
