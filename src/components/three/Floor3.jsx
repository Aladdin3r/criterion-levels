      ...
      {[-2.5, -1.0, 0, 1.0, 2.5].map((x, i) => (
        <group key={i} position={[x, 4.35, -5.5]}>
          ...
          <mesh position={[0, 0, 0]}>
            ...
            <meshStandardMaterial color="#4A4035" roughness={0.5} metalness={0.3} />
          </mesh>
          {/* Emissive bulb */}
        ...
        <group key={i} position={[cam.x, 0, cam.z]} rotation={[0, cam.rot, 0]}>
          ...
          {[-0.28, 0, 0.28].map((lx, li) => (
            <mesh key={li} position={[lx, 0.65, li === 1 ? -0.28 : 0.12]}
              ...
              <meshStandardMaterial color="#4A4035" roughness={0.5} metalness={0.5} />
            </mesh>
          ))}
          {/* Camera body */}
...
export default function Floor3() {
  return (
    <group position={[0, 0, 0]}>
      ...
      <directionalLight position={[0, 8, 4]} intensity={2.0} color="#FFF8F0" />
      ...
      <mesh position={[0, 2.5, -2]}>
        ...
        <meshStandardMaterial color="#4A4035" roughness={0.88} />
      </mesh>
